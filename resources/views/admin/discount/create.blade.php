                ...
                <div class="card_body m-2">
                    <form action="{{route('admin.discount.store')}}" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}"  value="{{old('name')}}" name="name" required>
                            @if ($errors -> has ('name'))
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control {{$errors->has('code') ? 'is-invalid' : ''}}" value="{{old('code')}}" name="code" required>
                            @if ($errors -> has ('code'))
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description" id="" cols="0" rows="2" class="form-control {{$errors->has('description') ? 'is-invalid' : ''}}" value="{{old('description')}}"></textarea>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" class="form-control {{$errors->has('percentage') ? 'is-invalid' : ''}}" min="1" max="100" value="{{old('percentage')}}" name="percentage" required>
